...
[Lettura principale](README.md) · [I sette principi](principles.md)
...
I [sette principi](principles.md) danno le leve per rispondere: ruoli delimitati, conoscenza governata, gate, artifact durevoli, validazione, composizione e adattamento. Non sono sette strumenti obbligatori da installare né richiedono lo stesso numero di agent in ogni progetto.
...
Nel tuo progetto scegli fonti, comandi realmente eseguibili, responsabilità e artifact proporzionati. Ispeziona le assunzioni se usi Bootstrap. Non inventare un comando o un'integrazione perché compare nell'esempio; non saltare un gate prescritto da un contratto già adottato.

Distinguere progettare un workflow proprio dall'adattare copie canonical tramite Bootstrap: in questo secondo caso si personalizzano gli slot dichiarati e approvati, preservando il testo fuori dagli slot. Le estensioni locali restano separate e non sovrascrivono le regole canonical. Se serve cambiare un contratto preservato, è un problema da riportare alla fonte, non una riscrittura libera della copia. Vedi il [contratto di preservazione](../public-package/skills/agentic-system/bootstrap-agentic-system/contracts/platform-compatibility.md).
...
Questo ciclo sviluppa la [composizione e il ciclo di vita](principles.md#6-composizione-e-ciclo-di-vita-espliciti) e l'[adattamento controllato](principles.md#7-bootstrap-e-adattamento-controllato), senza aggiungere un ottavo principio.
